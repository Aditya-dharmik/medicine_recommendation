...
def predict():
    if request.method=='POST':
        ...
        user_symptoms = [s.strip() for s in symptoms.split(',')]  # split symptoms by comma and strip any spaces
        user_symptoms = [sym.strip("[]'") for sym in user_symptoms]  # strip square brackets and quotes
